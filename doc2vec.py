...
def test():
    ...
    text_test = u'在时代下,信息管理与信息系统的应用越发受到人们重视饕餮。当下,信息资源炙手可热,尤其是各行各业正在大力发展的情况下,有必要完善信息管理与信息系统建设,创新企业管理模式,实现资源的优化配置和利用。笔者主要对时代下的信息管理与信息系统管理进行了分析。'
